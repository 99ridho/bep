...
Route::get('/about_us', ['uses' => 'HomeController@aboutUs', 'as' => 'about_us']);
...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::group(['middleware' => 'organizer', 'namespace' => 'Organizer'], function(){
       Route::get('manage_event', ['uses' => 'EventController@manage', 'as' => 'organizer_manage_event']);
        ...
        Route::get('manage_event/edit/{id}', ['uses' => 'EventController@indexEditEvent', 'as' => 'organizer_edit_event']);
        Route::post('manage_event/edit/{id}', ['uses' => 'EventController@editEvent', 'as' => 'organizer_save_edit_event']);
